...
\begin{description}
  ...
  \item[CSPS] Cesky Svaz Plaveckych Sportu = Czech Swimming Federation.
  
	\item[LAMP] Linux Apache MySQL PHP, blablabla.
	
	\item[SUS] System usability scale, blablalba. 
	
  \item[DOKS] Digital Ocean Kubernetes, cloud service Kubernetes.
