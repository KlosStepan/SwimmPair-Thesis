...
## TODOs
- [ ] Scénáře UX testing
- [ ] Konceptuální model - sdružování
- [ ] Popis uživatelů - co můžou dělat…jak(?) Analýza CO (1. kdo jsou uživatelé 2. co potřebují dělat 3.s čím pracují-data v db, co dělají (v analýze, spíše z příběhu)
- [ ] Funkcionality (light - „user stories“, atributy, 1 věta = 1 story), (heavy - „usecases“ a jejich potřeby - popis interakce mezi uživatelem a systémem…poté what can go wrongs) poté s čím - konceptuální model/entity relationship diagram (ER diagram, UML class diagramy - o světě)  
Poznámky k struktuře 
1. **Úvod todo** - user stories, use cases
2. **Návrh řešení** - architektura a technologie (struktura DB, objektový model, rozhraní, uživatelské rozhraní)
3. **Implementace**
4. **Otestování**
5. **Závěr** - diskuze, závěr, rozšiřování  

! Části systému - jisté, nejisté (3/5 (?)) - izolace stabilní nestabilní částí, nejisté

( Nástroje tipy
- plantum uml - kódový (VS Code také) - usecase diagramy
- draw io
- visual paradigm
...
! (wireframes, mockupování FE)  
! Waterfalling vs iterování

Analýza o iteracích
Závěr
- info newaterfalloval jsem, iteroval
- diskuze itearce
