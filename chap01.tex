\chapter{Status quo and solution proposition}
...
\par
Today is certain that there are users who want to browse our system from pc, tablet or smartphone and responsive design is a necessity. Since CSS3 \cite{lamport94} supports media queries we are going to use them for creation of device specific styling.
