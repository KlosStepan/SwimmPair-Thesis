...
Application that we are preparing is going to be used for 2 Regions and approximately 100 referees. Maximum scaling would be whole Czech republic, that means  5-6x larger load than the current one, which shouldn't be problem on LAMP stack. We can always scale up number of Kubernetes 